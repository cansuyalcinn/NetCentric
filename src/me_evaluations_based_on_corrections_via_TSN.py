...
# load MLA
if coadread_strat_498==True or c!='COADREAD':
    MLA_infile = '../data/MLA_ep_mutation_filtered_all_genes/{}_MLA_standardized.txt'.format(c)
else:
    MLA_infile = '../data/MLA_ep_mutation_filtered_all_genes/{}_MLA_standardized_559.txt'.format(c)
...
outfile_cgcg_cgnnb = '../results_main/evaluation_results/intact/results_counts_eval1_tsn/{}_{}_t{}_tsn{}_{}.txt'.format(c,tissue, t,threshold, '_'.join(methods))
outfile_cgcg_cgncgnb = '../results_main/evaluation_results/intact/results_counts_eval2_tsn/{}_{}_t{}_tsn{}_{}.txt'.format(c,tissue, t,threshold, '_'.join(methods))
